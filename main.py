...
def process_omr_sheet(image_path,filename, Sno, posScore, negScore, unattemptScore, threshold, answerKey,NoOfQues,selected_certificate):
    ...
    # Defining answers
        ...
        # cv2.waitKey(0)
        #Get perspective
        responseROI=omrUtlis.getPerspective(responseImg,150,350)
        ...
        for cnt in contours:
            ...
            if area>=70 and area<=100 and aspectRatio>=0.8:
        ...
        for idx2 in range(0,100):
            ...
            flag=0
            check=0
            if(idx2%25==0 and idx2!=0):  # calculating the correct index 35
                pos1+=4
                pos2+=1
        ...
        # print(score)
        # if ((NoOfQues == 140 and (paper2 < 11.55 or paper3 < 67.65 or paper4 < 36.3 or score < 115.5)) or
        #     (NoOfQues == 175 and (paper2 < 9.9 or paper3 < 69.3 or paper4 < 36.3 or score < 115.5))):
        #     result = "Fail"
        # elif score >= 245:
        #     result = "A"
        ...
        def flatten_list(lst):
            ...
            return flattened
        flattened_data = flatten_list([Sno,regNo,Set,gender,category,response_key,score])
        # flattened_data = flatten_list([Sno,regNo,Set,gender,category,response_key,score,result])
        print(filename,Sno,regNo,Set,gender,category,correctAns,IncorrectAns,Left,score,"\n")
        
        return [Sno,regNo,Set,gender,category,correctAns,IncorrectAns,Left,score],flattened_data,mainImage,responseROI
